...
from bist_bot.execution.base import AccountInfo, Order, OrderResult, OrderSide, OrderStatus, OrderType, Position
...
class DataFetcherProtocol(Protocol):
    ...
    def fetch_all(self, period: str = ..., interval: str = ..., force: bool = ...) -> dict[str, pd.DataFrame]: ...
