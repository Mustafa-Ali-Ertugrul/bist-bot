...
def inject_styles(sidebar_collapsed: bool = False) -> None:
    ...
    st.markdown(
        ...
        <style>
            ...
            /* ── Sidebar: native Streamlit layout, width controlled ── */
            section[data-testid="stSidebar"] {{
                width:{sw} !important;
                min-width:{sw} !important;
                max-width:{sw} !important;
                display:{sd} !important;
                transform:none !important;
                padding:18px 12px !important;
                overflow-y:auto !important;
                background:
                    radial-gradient(circle at 0% 0%, rgba(77,226,191,.12), transparent 40%),
                    linear-gradient(180deg, rgba(9,20,28,.96), rgba(8,13,19,.96)) !important;
            ...
            section[data-testid="stSidebar"] [data-testid="stSidebarUserContent"] > div:empty {{
                display:none !important;
            }}
            ...
            section[data-testid="stSidebar"] .stButton > button[kind="primary"] {{
                ...
                background:linear-gradient(135deg, var(--bb-secondary), var(--bb-primary)) !important;
            ...
            /* ── Sidebar toggle (HTML anchor, inside topbar brand) ── */
            .bb-sidebar-toggle-btn {{
            ...
            .bb-sidebar-toggle-btn:hover {{
                background:rgba(138,180,255,.12) !important;
                border-color:rgba(138,180,255,.22) !important;
                color:var(--bb-text) !important;
            }}
            div:has(> [data-testid="stMarkdownContainer"] .bb-sidebar-toggle-host) {{
            ...
            div.st-key-bb_sidebar_toggle_button {{
                position:fixed !important;
                top:14px !important;
                left:{toggle_left} !important;
                width:40px !important;
            ...
            div.st-key-bb_sidebar_toggle_button button {{
                width:40px !important;
                min-width:40px !important;
                height:40px !important;
                min-height:40px !important;
...
@media (max-width: 900px) {{
                ...
                .block-container {{
                    max-width:{mobile_bc_mw};
                    margin-left:{mobile_bc_ml};
                    margin-right:0;
                }}
                button[data-testid*="bb_sidebar_toggle"] {{
                ...
                div:has(> [data-testid="stMarkdownContainer"] .bb-sidebar-toggle-host)
                    + div:has(button),
                div.st-key-bb_sidebar_toggle_button {{
                    left:{mobile_toggle_left} !important;
                }}
                section[data-testid="stSidebar"] {{
                    width:{mobile_sw} !important;
                    min-width:{mobile_sw} !important;
                    max-width:{mobile_sw} !important;
                }}
                .bb-topbar-actions {{
                    gap:8px;
                }}
                .bb-topbar-actions .bb-badge {{
                    display:none;
                }}
                .bb-session-pill {{
                    display:none;
