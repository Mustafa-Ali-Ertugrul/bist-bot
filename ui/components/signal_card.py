...
from ui.components.chart_widget import render_chart
...
def render_signal_card(signal, df_data=None, chart_factory=None) -> None:
    ...
    <div style='border:1px solid rgba(255,255,255,0.06);background:{card_class};border-radius:20px;padding:20px;'>
      <div style='display:flex;justify-content:space-between;gap:12px;align-items:flex-start;'>
        ...
        <span style='display:inline-flex;align-items:center;padding:6px 10px;border-radius:999px;font-size:11px;font-weight:800;letter-spacing:0.12em;text-transform:uppercase;background:{chip_bg};color:{chip_color};'>{signal.signal_type.value}</span>
      </div>
