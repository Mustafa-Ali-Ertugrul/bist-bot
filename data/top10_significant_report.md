...
- Yillik Getiri: %48.89
- Maximum Drawdown: %-10.11 (`29.07.2025`)
- Ortalama Kazanan Islem: %6.92
...
- Toplam Islem Sayisi: 10
- Yillik Getiri: %24.36
- Maximum Drawdown: %-8.51 (`13.06.2025`)
- Ortalama Kazanan Islem: %5.71
...
- Toplam Islem Sayisi: 10
- Yillik Getiri: %60.78
- Maximum Drawdown: %-14.41 (`17.10.2025`)
- Ortalama Kazanan Islem: %12.85
...
- Toplam Islem Sayisi: 10
- Yillik Getiri: %54.31
- Maximum Drawdown: %-27.07 (`19.11.2025`)
- Ortalama Kazanan Islem: %9.79
...
- Yillik Getiri: %25.13
- Maximum Drawdown: %-16.52 (`23.10.2025`)
- Ortalama Kazanan Islem: %8.94
...
- Toplam Islem Sayisi: 10
- Yillik Getiri: %41.30
- Maximum Drawdown: %-21.99 (`20.11.2025`)
- Ortalama Kazanan Islem: %13.65
...
- Toplam Islem Sayisi: 10
- Yillik Getiri: %2.89
- Maximum Drawdown: %-15.50 (`13.04.2026`)
- Ortalama Kazanan Islem: %5.64
...
- Toplam Islem Sayisi: 10
- Yillik Getiri: %4.77
- Maximum Drawdown: %-19.33 (`11.11.2025`)
- Ortalama Kazanan Islem: %7.50
...
- Toplam Islem Sayisi: 10
- Yillik Getiri: %18.90
- Maximum Drawdown: %-24.56 (`04.03.2026`)
- Ortalama Kazanan Islem: %13.56
...
- Toplam Islem Sayisi: 10
- Yillik Getiri: %1.58
- Maximum Drawdown: %-18.73 (`05.01.2026`)
- Ortalama Kazanan Islem: %9.12
...
| --- | ---: | ---: | ---: | ---: |
| INDES (INDES.IS) | 32.85 | 5 | 100.0 | -7.49 |
| Ereğli (EREGL.IS) | 19.24 | 8 | 87.5 | -4.37 |
| Kayse (KAYSE.IS) | 15.68 | 8 | 87.5 | -8.37 |
| Ford Otosan (FROTO.IS) | 14.10 | 5 | 80.0 | -7.05 |
| ESCOM (ESCOM.IS) | 13.72 | 8 | 75.0 | -10.99 |
| Tüpraş (TUPRS.IS) | 13.49 | 6 | 83.3 | -7.97 |
| FRIGO (FRIGO.IS) | 13.43 | 8 | 75.0 | -12.31 |
| Aygaz (AYGAZ.IS) | 13.02 | 7 | 71.4 | -4.70 |
| ATATP (ATATP.IS) | 12.87 | 5 | 80.0 | -9.72 |
| DOCO (DOCO.IS) | 11.47 | 6 | 66.7 | -11.26 |
| Gülho (GLYHO.IS) | 10.95 | 5 | 60.0 | -8.89 |
| GOZDE (GOZDE.IS) | 10.79 | 7 | 85.7 | -10.37 |