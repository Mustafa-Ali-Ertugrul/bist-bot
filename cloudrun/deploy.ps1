...
gcloud run deploy $ApiServiceName `
    ...
    --timeout 360 `
    --set-env-vars "PYTHONPATH=/app/src,DB_PATH=/tmp/bist_signals.db,RATE_LIMIT_STORAGE_URI=memory://,TRUSTED_PROXY_HOPS=0,EXPECTED_INSTANCE_COUNT=1,WATCHLIST_SOURCE=bist30" `
